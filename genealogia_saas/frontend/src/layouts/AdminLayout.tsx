  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemButton component={RouterLink} to="/admin/organizations">
            <ListItemIcon>
              <BusinessIcon />
            </ListItemIcon>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar
        ...
        sx={{
          ...
          bgcolor: 'error.main', // Cor diferente para distinguir do dashboard normal
        }}
      >
        <Toolbar>
          <IconButton
